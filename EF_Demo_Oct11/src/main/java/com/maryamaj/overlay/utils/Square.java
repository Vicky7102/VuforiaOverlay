...
public class Square {
    ...
    static float squareCoords[] = {
            -0.5f,  0.5f, 0.0f, 1f,  // top left
            -0.5f, -0.5f, 0.0f, 1f,  // bottom left
             0.5f, -0.5f, 0.0f, 1f,  // bottom right
             0.5f,  0.5f, 0.0f, 1f }; // top right
    ...
    public Square() {
        ...
        mProgram=SampleUtils.createProgramFromShaderSrc(vertexShaderCode, fragmentShaderCode);
